...
title('Forward Guidance Shock: Spectral Density of 2-Sided Predictor','fontsize',22,'interpreter','latex')
...
for j = 1:3
    ...
    if j == 2
        legend({'Truth','Lower Bounds'},'Location','South','fontsize',16,'interpreter','latex')
    end
    grid on
    hold off
end
