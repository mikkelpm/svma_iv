...
var ewma epinfma yf y r a b g qs ms spinf sw kpf kp cf invef c inve pinf w lab zcapf rkf kf pkf labf wf rrf mc zcap rk k pk z_ext;    
 
varexo em ea eb eg eqs epinf ew enu;  
...
parameters curvw cgy curvp constelab constepinf constebeta cmaw cmap calfa 
    ...
    ctrend cg
    sigma_a sigma_b sigma_g sigma_qs sigma_m sigma_pinf sigma_w sigma_nu_ext alpha_ext;
...
z_ext = alpha_ext * em + sigma_nu_ext * enu;
...
//stoch_simul(order=1,irf=40) y r pinf;